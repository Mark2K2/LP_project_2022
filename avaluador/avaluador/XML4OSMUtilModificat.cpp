	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Carrer de Velázquez"),
					}
				),
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Ronda del Guinardó"),
					}
				),
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "oneway"),
	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Plaça del Doctor Moragas"),
					}
				),
			}
		}
	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Carrer de la Indústria"),
					}
				),
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "oneway"),
	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Carrer de González"),
					}
				),
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "oneway"),
	...
	m_conjuntTest1->push_back(
		XmlElement{
			...
			// children
			{
				...
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "name"),
						std::make_pair("v", "Passeig de les Acàcies"),
					}
				),
				std::make_pair<std::string, std::vector<PAIR_ATTR_VALUE>>("tag", {
						std::make_pair("k", "oneway"),
